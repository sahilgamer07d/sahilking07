...
UNIBORG_USER_BOT_WARN_ZERO = "`I AM SORRY BUT MY MASTER DOESN'T ACCEPT PM's ANYMORE HE CAN BE CONTACTED FROM HERE` @AYSHACKS2\n\n`SORRY BUT AS PER MY MASTER'S INSTRUCTIONS I HAVE TO BLOCK U AND REPORT U AS SPAM 😔`"
